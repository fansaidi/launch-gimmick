...
// Intro/reward step: plays a full-bleed video file. Completes automatically
// when the video ends, or on tap when `autoAdvance` is false (e.g. a reward
// the user dismisses themselves). For YouTube/embed links, see media.embed.
